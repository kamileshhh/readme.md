...
### *License*
This project is licensed under the MIT License. See the [LICENSE](LICENSE.md) file for details.# *Retail Discount and Analysis*
...
### contribution
-*Ziya- Codes and output 
-*Kamil- README.md
-*Kirtan- Amazon Sales dataset
-*Saloni- Big Bazaar sales dataset
-*Shubham- Docs and Codes
